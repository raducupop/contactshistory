...
public class DBAdapter {
	    ...
	    private static final String DATABASE_CREATE = "create table people (_id integer primary key autoincrement, key text not null, date text not null, location text not null, address text not null);";
